...
class SignUpEventType extends SignUpEvent {
  final String type;

  const SignUpEventType(this.type);

  @override
  List<Object> get props => [type];
}

class SignUpEventCity extends SignUpEvent {
  final String type;

  const SignUpEventCity(this.type);

  @override
  List<Object> get props => [type];
}

class SignUpEventState extends SignUpEvent {
  final String state;

  const SignUpEventState(this.state);
