...
final class AddPropertyEdited extends AddPropertyState {
  final SinglePropertyModel editInfo;
...
final class AddProjectEdited extends AddPropertyState {
  final ProjectResponse editInfo;

  const AddProjectEdited(this.editInfo);
