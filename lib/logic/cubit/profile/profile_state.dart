...
class PropertyLoaded extends ProfileState {
  final PropertyListResponse profile;

  const PropertyLoaded(this.profile);

  @override
  List<Object> get props => [profile];
}

class ProjectLoaded extends ProfileState {
  final ProjectListResponse profile;

  const ProjectLoaded(this.profile);
