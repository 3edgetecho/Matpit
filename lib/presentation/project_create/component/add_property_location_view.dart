...
class AddProjectLocationView extends StatefulWidget {
  const AddProjectLocationView({super.key});

  @override
  State<AddProjectLocationView> createState() =>
      _AddPropertyLocationViewState();
}

class _AddPropertyLocationViewState extends State<AddProjectLocationView> {
