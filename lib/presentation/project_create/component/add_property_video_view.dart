...
import '../../screens/profile/component/person_single_property.dart';
...
class AddProjectVideoView extends StatefulWidget {
  const AddProjectVideoView({super.key});

  @override
  State<AddProjectVideoView> createState() => _AddPropertyVideoViewState();
}

class _AddPropertyVideoViewState extends State<AddProjectVideoView> {
    ...
    return BlocBuilder<AddPropertyCubit, AddPropertyModel>(
      builder: (context, state) {
        ...
        return Container(
          ...
          child: Column(
            children: [
              const FormHeaderTitle(title: "Project Video"),
              Padding(
