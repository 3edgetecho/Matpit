...
import 'package:real_estate/presentation/screens/profile/project_screen.dart';

import '../project_create/new_property_create_screen.dart';
...
import '../screens/profile/property_screen.dart';
...
class RouteNames {
  ...
  static const String newProjectCreateScreen = '/newProjectCreateScreen';
  ...
  static Route<dynamic> generateRoutes(RouteSettings settings) {
    switch (settings.name) {
      ...
      case RouteNames.profileScreen:
        ...
        case RouteNames.propertyScreen:
        return MaterialPageRoute(
            settings: settings, builder: (_) => const PropertyScreen());

        case RouteNames.projectScreen:
        return MaterialPageRoute(
            settings: settings, builder: (_) => const ProjectScreen());
      ...
      case RouteNames.propertyDetailsScreen:
        ...
        case RouteNames.projectDetailsScreen:
                final slug = settings.arguments as String;
                return MaterialPageRoute(
                    settings: settings,
                    builder: (_) => ProjectDetailScreen(slug: slug));
      ...
      case RouteNames.allSettingScreen:
        return MaterialPageRoute(
            settings: settings, builder: (_) =>  AllSettingScreen(isShowBack:false));
      ...
      case RouteNames.newPropertyCreateScreen:
        ...
        case RouteNames.newProjectCreateScreen:
        final id = settings.arguments as String;
        return MaterialPageRoute(
            settings: settings,
            builder: (_) => NewProjectCreateScreen(id: id));
