...
import '../../utils/k_strings copy.dart';
...
class AllSettingScreen extends StatelessWidget {
  bool isShowBack = false;
   AllSettingScreen({super.key,required this.isShowBack});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:  ProfileAppBar(isSHowBack: isShowBack),
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                loginBloc.userInfo!.type == "vendor" ? SingleElement(
                  icon: KImages.userIcon,
                  text: 'My Profile',
                ...
                //   },
                // ),
                loginBloc.userInfo!.type == "vendor" ? SizedBox(): SingleElement(
                ...
                //     onTap: () {
                //       if (loginBloc.userInfo != null ) {
                //         Navigator.pushNamed(context, RouteNames.myDealsScreen);
                //       } else {
                //         Utils.showSnackBarWithLogin(context);
                //       }
                //     }
                ...
                loginBloc.userInfo!.type == "vendor" ? SingleElement(
                    ...
                    onTap: () {
                      if (loginBloc.userInfo != null ) {
                        Navigator.pushNamed(context, RouteNames.propertyScreen);
                      } else {
                        Utils.showSnackBarWithLogin(context);
                      }
                    }
                ...
                loginBloc.userInfo!.type == "vendor" ? SingleElement(
                    ...
                    onTap: () {
                      if (loginBloc.userInfo != null ) {
                        Navigator.pushNamed(context, RouteNames.premiumMembershipScreen);
                      } else {
                        Utils.showSnackBarWithLogin(context);
                      }
                    }
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                logoutButton('Logout', () async {
                  SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
                  sharedPreferences.remove(KStrings.cachedUserResponseKey);
                  Navigator.pushNamedAndRemoveUntil(
                      context, RouteNames.loginScreen, (route) => false);
                  Utils.showSnackBar(context, "Logout");
                }, redColor),
...
class ProfileAppBar extends StatefulWidget implements PreferredSizeWidget {
   bool isSHowBack = false;
   ProfileAppBar({super.key,required this.isSHowBack});
...
class _ProfileAppBarState extends State<ProfileAppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    if (users.users != null) {
      userImage = users.users!.image!=null && users.users!.image!.isNotEmpty
          ...
          widget.isSHowBack ? FittedBox(
            ...
            onTap: () {
              if (loginBloc.userInfo != null) {
                Navigator.pushNamed(
                    context, RouteNames.updateProfileScreen,
                    arguments: profile.agentDetailModel);
              } else {
                Utils.showSnackBarWithLogin(context);
              }
            },
