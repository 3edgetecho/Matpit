                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          onChanged: (val) {
                            ...
                            setState(() {
                              loginBloc.add(LoginUserType(val.toLowerCase()));
                            });
                          },
                        ),
                        spacer,
                        ...
                        //       final loginBloc = context.read<LoginBloc>();
                        //
                        //       // 1️⃣ Set static dummy credentials
                        //       loginBloc.add(const LoginUserType("guest")); // or "vendor"
                        //       loginBloc.add(const LoginEvenEmailOrPhone(""));
                        //       loginBloc.add(const LoginEventPassword(""));
                        //
                        //       // 2️⃣ Call same login API
                        //       loginBloc.add(const LoginEventSubmit());
                        //       Navigator.pushNamed(context, RouteNames.mainPageScreen);
                        //     },
                        ...
                        Center(
                          child: TextButton(
                            onPressed: () {
                              context.read<LoginBloc>().add(const LoginAsGuest());
                            },
                            child: const CustomTextStyle(
                              textAlign: TextAlign.center,
                              text: "Guest Login",
