                  ...
                  child: isAction
                      ? BlocListener<BookingCubit, BookingModel>(
                          listener: (context, book) {
                            ...
                            if (state is CompareRemoving) {
                              ...
                              if (state is CompareError) {
                                ...
                                context
                                    .read<BookingCubit>()
                                    .addSingComId(compareList[i].property!.id!.toInt());
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              String id = compareList[i].property!.id!.toString();
                          ...
                          child: GestureDetector(
                            onTap: () {
                              ...
                              //         slug: compareList[i].slug)));
                               Navigator.pushNamed(context, RouteNames.propertyDetailsScreen,arguments: compareList[i].property!.slug!);
                            },
                            child: CustomTextStyle(
                              text: valueGetter(i),
