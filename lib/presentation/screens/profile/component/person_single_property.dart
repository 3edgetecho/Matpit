...
class _PersonSinglePropertyState extends State<PersonSingleProperty> {
  ...
  late List<Data> _filteredAgents; // To store filtered agents
  ...
  void _onSearchChanged(String query) {
    setState(() {
      ...
      _filteredAgents = widget.properties.where((agent) {
        ...
        return agent.propertyContents != null &&
            agent.propertyContents!.any((content) =>
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    Image.network(
                                          ...
                                          RemoteUrls.propertyFeatureURL+result.featuredImage!,
                                      height: 140.0,
                                      width: 140.0,
                                      fit: BoxFit.cover,
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    CustomTextStyle(
                                      text: result.propertyContents![0].title!,
                                      color: blackColor,
                                      ...
                                      children: [
                                        ...
                                        Flexible(
                                          child: CustomTextStyle(
                                            text: result.propertyContents![0].address!,
                                            color: grayColor,
                                            fontWeight: FontWeight.w400,
                                            fontSize: 14.0,
                                            maxLine: 2,
