...
//
//   // ---------------------------
//   // NULL SAFE FROM MAP (MAIN FIX)
//   // ---------------------------
//   factory MobileContent.fromMap(Map<String, dynamic>? json) {
//     if (json == null) return MobileContent.empty();
//
//     return MobileContent(
//       id: _toInt(json['id']),
//       splashScreen: _toStr(json['splash_screen']),
//       onboardingOneTitle: _toStr(json['onboarding_one_title']),
//       onboardingOneDescription: _toStr(json['onboarding_one_description']),
//       onboardingOneIcon: _toStr(json['onboarding_one_icon']),
//       onboardingTwoTitle: _toStr(json['onboarding_two_title']),
//       onboardingTwoDescription: _toStr(json['onboarding_two_description']),
//       onboardingTwoIcon: _toStr(json['onboarding_two_icon']),
//       onboardingThreeTitle: _toStr(json['onboarding_three_title']),
//       onboardingThreeDescription: _toStr(json['onboarding_three_description']),
//       onboardingThreeIcon: _toStr(json['onboarding_three_icon']),
//       loginBgImage: _toStr(json['login_bg_image']),
//       loginPageLogo: _toStr(json['login_page_logo']),
...
//
//   factory MobileContent.fromJson(String source) =>
//       MobileContent.fromMap(json.decode(source));
//
//   @override
//   List<Object> get props => [
//     id,
